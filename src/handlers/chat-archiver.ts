...
export function registerChatArchiver(
  ...
  // Note: message_sending/message_sent hooks don't fire for Telegram outgoing messages.
  // Bot replies are captured in agent-logger.ts via llm_output → insertChatMessage.
